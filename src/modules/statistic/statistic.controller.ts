...
export class StatisticController {
  ...
  public countNewUserByMonth = async (
    ...
    try {
      const year = isNaN(Number(req.query.year))
        ? new Date().getFullYear()
        : Number(req.query.year);
      const countNewUsers = await this.statisticService.countNewUserByMonth(
        year
      );
  ...
  public countNewUserByYear = async (
    ...
    try {
      const year = isNaN(Number(req.query.year))
        ...
        : Number(req.query.year);
      const countNewUsers = await this.statisticService.countNewUserByYear(
        year
      );
      res.json(new ResponseData(countNewUsers, null, null));
    } catch (error) {
  ...
  public countUserByStatus = async (
    ...
    try {
      const countUsers = await this.statisticService.countUserByStatus();
      res.json(new ResponseData(countUsers, null, null));
    } catch (error) {
      console.log("🚀 ~ StatisticController ~ error:", error);
      next(error);
    }
  ...
  public countInspectorByMonth = async (
    ...
    try {
      const year = isNaN(Number(req.query.year))
        ? new Date().getFullYear()
        : Number(req.query.year);
      const countInspectors = await this.statisticService.countInspectorByMonth(
        year
      );
  ...
  public countInspectorByYear = async (
    ...
    try {
      const year = isNaN(Number(req.query.year))
        ? req.query.year.toString()
        : Number(req.query.year);
      const countInspectors = await this.statisticService.countInspectorByYear(
        year
      );
      res.json(new ResponseData(countInspectors, null, null));
    } catch (error) {
  ...
  public countInspectorByStatus = async (
    ...
    try {
      const countInspectors =
        await this.statisticService.countInspectorByStatus();
      res.json(new ResponseData(countInspectors, null, null));
    } catch (error) {
      console.log("🚀 ~ StatisticController ~ error:", error);
      next(error);
  ...
  public countHostandUserByMonth = async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
    try {
      const year = isNaN(Number(req.query.year))
        ? new Date().getFullYear()
        : Number(req.query.year);
      const countHostandUser =
        await this.statisticService.countHostandUserByMonth(year);
      res.json(new ResponseData(countHostandUser, null, null));
    } catch (error) {
      console.log("🚀 ~ StatisticController ~ error:", error);
      next(error);
    }
  ...
  public countHostandUserByYear = async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
    try {
      const year = isNaN(Number(req.query.year))
        ...
        : Number(req.query.year);
      const countHostandUser =
        await this.statisticService.countHostandUserByYear(year);
      res.json(new ResponseData(countHostandUser, null, null));
    } catch (error) {
      console.log("🚀 ~ StatisticController ~ error:", error);
      next(error);
  ...
  public countEmployeeandUserByMonth = async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
    try {
      const year = isNaN(Number(req.query.year))
        ? new Date().getFullYear()
        : Number(req.query.year);
      const countEmployeeandUser =
        await this.statisticService.countEmployeeandUserByMonth(year);
      res.json(new ResponseData(countEmployeeandUser, null, null));
    } catch (error) {
      console.log("🚀 ~ StatisticController ~ error:", error);
      next(error);
    }
  ...
  public countEmployeeandUserByYear = async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
    try {
      const year = isNaN(Number(req.query.year))
        ...
        : Number(req.query.year);
      const countEmployeeandUser =
        await this.statisticService.countEmployeeandUserByYear(year);
      res.json(new ResponseData(countEmployeeandUser, null, null));
    } catch (error) {
      console.log("🚀 ~ StatisticController ~ error:", error);
      next(error);
